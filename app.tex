...
\begin{frame}{Contextualização}
  \begin{itemize}
    ...
    \end{itemize}
    \item (Rocha et al., 2010) 98\% de acurácia após aquisição, pré-processamento e segmentação; % frutas
...
\begin{frame}{Extração de Características}
\begin{itemize}
\item[GCH] Histograma global de cor. $N$ dimensões, sendo $N$ o número de intensidades. % Mais simples representação. 

\item[CCV] Vetor de coerência de cor. Classifica os pixels da imagem em coerentes e incoerentes, computa os respectivos histogramas de acordo com um \textit{threshold} e os concatena. $2N$D. % informações sobre como as cores são organizadas em 
...
\begin{itemize}
  \item Reconhecimento humano de novos padrões está relacionada com a capacidade de generalização, através de hierarquias.% \cite{thesisDeep}. 
  ...
  \item Conhecimento através da experiência: ao tentar uma solução e errar, aprendem e podem tentar novamente. Neurônios de entrada, ocultos e de saída. Aprender = encontrar os pesos para exibir o comportamento esperado%. \cite{Schmidhuber2014}.
...
\begin{frame}{Deep Learning}
 \begin{figure}[hbpt]
 \begin{center}
   \includegraphics[width=0.8\linewidth]{\detokenize {figuras/convnet.png}}
 \end{center}
  \caption{}
\end{figure}
\end{itemize}
...
\begin{figure}[htb]
 \begin{center}
   \includegraphics[width=0.6\linewidth]{\detokenize {figuras/resultado-melhor4.png}}
 \end{center}
...
\begin{figure}[htb]
 \begin{center}
   \includegraphics[width=0.6\linewidth]{\detokenize {figuras/resultado-pior1.png}}
 \end{center}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Resultados Preliminares} % Novos resultados

% cnn balanceada, desbalanceada, rebalanceada
